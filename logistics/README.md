...
Um conjunto de coisas que são importantes durante a organização de um evento Python Campus. Não vamos tentar explicar tudo nos mínimos detalhes, mas nós fazemos a elaboração de algumas coisas mais importantes:

## Local de reunião

Regra geral sobre o local: muitas vezes você pode obter um espaço de graça. Seus alvos são: grandes espaços de coworking, hackerspaces, makerspaces, universidades. Estes são os lugares que podem estar dispostos a oferecer-lhe espaço gratuitamente (especialmente durante os fins de semana).

A instalação deve permitir você sentar confortavelmente.
